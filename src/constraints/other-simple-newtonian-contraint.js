...
export let otherSimpleNewtonianParticles = [];
...
let magenta = create(100, "cyan", simpleNewtonianParticles);

export function appliedOtherSimpleNewtonianConstraints() {
  ...
  constraints(magenta, cyan, -0.69);
  constraints(magenta, green, -0.666);
  constraints(magenta, magenta, -0.024);
  constraints(magenta, red, -0.420);
  constraints(magenta, yellow, -0.96);
